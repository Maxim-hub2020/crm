...
from .views import (
    ...
    cash_forecast_view,
    calculator_quote_detail_view,
    calculator_quotes_view,
    calculator_production_plan_view,
...
router.register(r"measurement-scan-sessions", MeasurementScanSessionViewSet, basename="measurement-scan-sessions")
...
urlpatterns = [
    ...
    path("calculator-production/analyze/", calculator_production_plan_view),
